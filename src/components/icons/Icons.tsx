...
export const HelpIcon = ({ className = DEFAULT_CLASS }: IconProps) => (
  ...
  >
    <path
      ...
      strokeWidth={2}
      d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.279 2.575-3.006 2.907-.542.104-.994.54-.994 1.093v.5"
    />
...
export const CalculatorIcon = ({ className = DEFAULT_CLASS }: IconProps) => (
  ...
  >
    ...
    <path
      strokeLinecap="round"
      strokeWidth={2}
      d="M7 7h10M7 12h.01M11 12h.01M15 12h.01M7 16h.01M11 16h.01M15 16h.01"
    />
  </svg>
);
...
export const TipIcon = ({ className = DEFAULT_CLASS }: IconProps) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M9 18h6M10 21h4M12 3a6 6 0 00-3.5 10.9c.5.36.8.93.8 1.55V16h5.4v-.55c0-.62.3-1.19.8-1.55A6 6 0 0012 3z"
    />
  </svg>
);
